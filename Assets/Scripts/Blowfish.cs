...
public class Blowfish : MonoBehaviour {
		...
		public class BLOWFISH_CTX
		{
				public ulong[] P = new ulong[18];
				public ulong[,] S = new ulong[4,256];
		};

			

		private readonly static ulong[] ORIG_P =
		{
...
//		};
private readonly static ulong[,] ORIG_S =
		{{
...
//KS3 =
{
		...
		void Awake()
		{
				Default.Namespace.Globals.g_blowfish = this;
		}
